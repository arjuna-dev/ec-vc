...
- `docs/003/Active/003-Games.md` describes root Games rules
- `docs/030/Active/030-Game_Operation.md` describes Games operation
...
There is also an `LDB` subset inside `Files`.

`LDB` files are reusable reference files that support other records with shared taxonomies, terms, stages, securities, industries, and similar evolving reference sets.
...
This is the default contract for new `LDB` files such as:
