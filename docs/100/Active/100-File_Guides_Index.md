...
| `Artifact Processed` | `Draft` | `partially born` | `docs/100/Draft/100-Artifact_Processed.md` | `docs/001/Active/001-Files.md` | `Provenance Steward` | Mapped file guide created in prep pass. Runtime surface exists; promotion review still pending. |
