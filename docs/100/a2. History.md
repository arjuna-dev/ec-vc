...
- file name: `Events`
- file guide: `docs/100/a2. History.md`
...
`Events` is governed by `Owner`, `Intake`, `File`, and canonical/runtime audit contracts.
...
- file guide exists: `yes`, `docs/100/a2. History.md`
