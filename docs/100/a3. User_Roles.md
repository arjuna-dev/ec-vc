...
- file guide: `docs/100/a3. User_Roles.md`
...
`User Roles` is governed by `Owner`, `File`, access architecture, and naming/glossary rules.
...
- file guide exists: `yes`, `docs/100/a3. User_Roles.md`
