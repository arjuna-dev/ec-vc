...
- file name: `Users`
- file guide: `docs/100/a5. Users.md`
...
`Users` is governed by `Owner`, `File`, access architecture, and future access-assignment rules.
...
- file guide exists: `yes`, `docs/100/a5. Users.md`
