...
- file name: `Intake`
- file guide: `docs/100/b2. Intake.md`
...
`Intake` is governed by `Owner`, `Intake`, `File`, and intake/reconnect rules.
...
- file guide exists: `yes`, `docs/100/b2. Intake.md`
