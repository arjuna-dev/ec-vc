...
- file name: `Files`
- file guide: `docs/100/100-Files.md`
...
This guide is different from `docs/010/DAMP.md`.

- `docs/010/DAMP.md` is the parent rule and architecture authority for file guides.
- `docs/100/100-Files.md` is the guide for the actual `Files` canonical entity and registry table.
- `docs/100/100-System_Files.md` is the guide for the app-facing `System Files` surface backed by `Files`.
...
- file guide exists: `yes`, `docs/100/100-Files.md`
...
- Should `Files` eventually generate `docs/100/100-File_Guides_Index.md` automatically?
