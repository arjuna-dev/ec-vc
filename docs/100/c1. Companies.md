...
- file name: `Companies`
- file guide: `docs/100/c1. Companies.md`
...
`Companies` is governed by `Owner`, `File`, and company relationship/provenance rules.
...
- file guide exists: `yes`, `docs/100/c1. Companies.md`
