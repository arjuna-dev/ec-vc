...
- file guide: `docs/100/c2. Opportunities.md`
...
`Opportunities` is governed by `Owner`, `File`, branch metadata rules, and relationship contracts.
...
- file guide exists: `yes`, `docs/100/c2. Opportunities.md`
