...
- file name: `Projects`
- file guide: `docs/100/c3. Projects.md`
...
`Projects` is governed by `Owner`, `File`, workflow architecture, and future access-assignment usage.
...
- file guide exists: `yes`, `docs/100/c3. Projects.md`
