...
- file name: `Rounds`
- file guide: `docs/100/c8. Rounds.md`
...
`Rounds` is governed by `Owner`, `File`, branch rules, and round-specific structure contracts.
...
- file guide exists: `yes`, `docs/100/c8. Rounds.md`
