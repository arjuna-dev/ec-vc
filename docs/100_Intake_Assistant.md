...
It should inherit the base rules from `docs/000-Companion_Manual.md` and then add the role-specific working direction for ingestion.
...
- inherit all baseline companion rules from `docs/000-Companion_Manual.md`
