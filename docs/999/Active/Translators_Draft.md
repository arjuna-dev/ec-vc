...
This is a temporary drafting file for translators.

It exists to help us:

- track translator candidates
...
We are trying to converge important utility-enhanced components into translators.
...
- identify BB/sample components that are rendering shared behavior through local sample logic instead of approved assets
...
- the translator has an approved shape
