...
function listTasksForPage() {
  return dbAll(
    ...
    SELECT DISTINCT
      t.id,
      t.Task_Name,
      NULL AS Task_Summary,
      t.Status AS Task_Status,
      NULL AS Task_Priority_Rank,
      ...
      if (error === 'invalid') {
        ...
        if (!generalSection) {
          addIssue({
            ...
            suggestedAction: 'Restore the General section with the Name token and approved file tokens.',
          })
        } else {
