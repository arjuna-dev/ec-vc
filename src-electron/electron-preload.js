...
const api = {
  ...
  records: {
    ...
    shellUpdate: ({ tableName, recordId, changes, verification, actionId, actionLabel } = {}) =>
      ipcRenderer.invoke('records:shellUpdate', { tableName, recordId, changes, verification, actionId, actionLabel }),
