...
const pageShellLabel = computed(() => {
  const routeLabel = routeRegistryEntry.value?.label
  if (routeLabel === 'Funds' || routeLabel === 'Rounds') return 'Opportunities'
  return routeLabel || activeRegistryEntry.value?.label || 'Records'
})
