  ...
  <q-page class="q-pa-md">
    ...
    <div v-else class="databook-page">
      ...
      <q-banner v-if="error" class="bg-red-2 text-black" rounded>
        ...
        <div v-if="isUserView || isArtifactView" class="contact-databook">
          <section
            ref="contactHeroRef"
...
// Legacy contact/company branch symbols kept temporarily while shared renderer cleanup is in progress.
const __legacyBranchSymbols = [
  contactRoleCompany,
  contactLocation,
  contactAvatarImage,
  hasContactCustomImage,
  contactInitials,
  contactAvatarColor,
  companyLogoImage,
  hasCompanyCustomLogo,
  contactHeroPills,
  contactSummaryStats,
  companyType,
  companyOneLiner,
  ...
  contactActionLinks,
  companyNavItems,
  activeCompanyContentSection,
  contactNavItems,
  activeContentSection,
  contactHeroNotes,
  companyHeroNotes,
  contactHeroDocuments,
  companyHeroDocuments,
  contactKdbSectionOptions,
  companyKdbSectionOptions,
  contactKdbKindOptions,
  contactKdbSearchPlaceholder,
  displayContactKdbItems,
  companyKdbKindOptions,
  companyKdbSearchPlaceholder,
  displayCompanyKdbItems,
  contactMetaItems,
  companyMetaItems,
  visibleSystemFields,
  onContactDocumentsDrop,
  downloadContactDocument,
  previewContactDocument,
  shareContactDocument,
  triggerContactImagePicker,
  triggerCompanyLogoPicker,
  removeContactImage,
  removeCompanyLogo,
]
void __legacyBranchSymbols
