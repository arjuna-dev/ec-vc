...
const companionDocumentMenu = [
  {
    ...
    label: 'Companion',
    short: 'Main contract',
    path: 'docs/002/Active/002-Companion_Manual.md',
    eyebrow: 'Companion',
    heroTitle: 'Companion',
  },
  {
    ...
    path: 'docs/010/Active/010-record-architecture-master-plan.md',
  ...
  },
  {
    ...
    label: 'Game Rulebook',
    short: 'Boards + points',
    path: 'docs/300/Active/300_Game_Rulebook.md',
  ...
  },
  {
    ...
    path: 'docs/020/Active/020_Game_Steward.md',
