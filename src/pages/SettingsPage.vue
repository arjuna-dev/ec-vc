...
const companionDocumentMenu = [
  ...
  },
  {
    ...
    path: 'docs/999/a. ECS_Tracker.md',
    eyebrow: 'Tracker',
    heroTitle: 'Tracker',
  },
  {
  ...
  },
  {
    ...
    short: 'Concept index',
    path: 'docs/000/Archive/000-language-reference-glossary.md',
