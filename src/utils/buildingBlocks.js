...
export const BUILDING_BLOCK_DETAILS_BY_ID = {
  ...
  'page-title': defineBuildingBlockDetail({
    ...
    nextStep: 'Extract the shared page-title block so shell pages stop hand-rendering this title treatment.',
  ...
  'value-chip': defineBuildingBlockDetail({
    ...
    status: 'extract',
    statusLabel: 'Extract Next',
    source: 'Live shell selector chip in src/layouts/MainLayout.vue',
    nextStep: 'Extract the black value chip so selectors and shell status chips can reuse one canonical payload surface.',
  ...
  'dropdown-chevron': defineBuildingBlockDetail({
    ...
    status: 'extract',
    statusLabel: 'Extract Next',
    source: 'Live shell selector chevron in src/layouts/MainLayout.vue',
    nextStep: 'Extract the selector chevron so shell dropdown affordances stop relying on local icon positioning.',
